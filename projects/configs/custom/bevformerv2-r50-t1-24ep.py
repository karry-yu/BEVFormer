...
train_pipeline = [
    ...
    # dict(type='DD3DMapper', is_train=True, tasks=dict(box2d_on=True, box3d_on=True), )
]
...
model = dict(
    ...
    frames=frames,
    pretrained=dict(img='./Checkpoints/pretrained/torch/hub/checkpoints/resnet50-0676ba61.pth'),
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
work_dir = "./Checkpoints/BEVFormer/bevformerv2-r50-t1-24ep"
